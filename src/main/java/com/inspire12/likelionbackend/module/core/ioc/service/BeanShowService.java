...
import com.inspire12.likelionbackend.module.core.ioc.config.BeanComponentSearchConfig;
...
//        myService.sayName();
        ...
        ApplicationContext context =
                new AnnotationConfigApplicationContext(BeanComponentSearchConfig.class);
